...
class DashboardBloc extends Bloc<DashboardEvent, DashboardState> {
  ...
  exportDataToExcel(var data, bool exportToIncludeWholeData, String exportType, BuildContext context) async {
    CustomAlert.showCustomScaffoldMessenger(
      mainNavigatorKey.currentContext!,
  ...
  Future<FilterAndSummaryForProject?> updateSelectedFilters(List<String?> filters, FilterAndSummaryForProject? filterData) async {
